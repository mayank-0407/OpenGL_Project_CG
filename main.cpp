...
bool checkifwin()
{
	...
	//check if there is any diagonal win i.e. if there is any 
	//diagonals that has same value
	for (i = 1; i <= 2; i++)
	{
...
//This function checks if the match is a draw i.e it
//returns false if there is atleast one empty box else returns true 
bool checkifdraw()
{
	int i, j;
	bool draw;
